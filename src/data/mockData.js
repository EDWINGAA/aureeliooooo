...
export const accesoriosData = [
  {
    ...
    categoria: 'Fundas',
    precio: 15,
    descripcion: 'Funda de silicona suave con protección completa',
    disponible: true,
    imagen: '📱'
  },
  {
    ...
    categoria: 'Fundas',
    precio: 12,
    descripcion: 'Funda transparente resistente a golpes',
    disponible: true,
    imagen: '📱'
  },
  {
    ...
    categoria: 'Cristales',
    precio: 10,
    descripcion: 'Protector de pantalla con dureza 9H',
    disponible: true,
    imagen: '🛡️'
  },
  {
    id: 'a4',
    nombre: 'Cristal Privacidad',
    categoria: 'Cristales',
    precio: 18,
    descripcion: 'Cristal templado con filtro de privacidad',
    disponible: true,
    imagen: '🛡️'
  },
  {
    ...
    precio: 25,
    descripcion: 'Cargador USB-C con carga rápida',
    disponible: true,
    imagen: '⚡'
  },
  {
    ...
    categoria: 'Cables',
    precio: 12,
    descripcion: 'Cable certificado MFi de 2 metros',
    disponible: true,
    imagen: '🔌'
  },
  {
    ...
    categoria: 'Cargadores',
    precio: 30,
    descripcion: 'Base de carga inalámbrica 15W',
    disponible: true,
    imagen: '⚡'
  },
  {
  ...
  },
  {
    ...
    precio: 8,
    descripcion: 'Soporte adhesivo para teléfono',
    disponible: true,
    imagen: '🔘'
  },
  {
    ...
    categoria: 'Accesorios',
    precio: 20,
    descripcion: 'Soporte magnético para rejilla de ventilación',
    disponible: true,
    imagen: '🚗'
  },
];
